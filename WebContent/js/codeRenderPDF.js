...
var CodeRenderer =
	{
		Java:
		{
			tab:
				"<div class=tab></div>",
			keywords:
				["system.out.print","system.out.println","string" ,"abstract", "default","assert","class"
					,"const","do","extends","interface","import","throw","true","false","null",
					"super", "for", "while", "finally", "case", "return", "default", "break", "try",
					"catch", "new ", "if", "else", "switch", "do  ", "while", "int ", "double ", "float ",
					"boolean ", "char ", "short ", "long ", "byte ", "package ", "class ", "private ", "this ",
					"public ", "static ", "void"],
			variables:
				[],
			props:
